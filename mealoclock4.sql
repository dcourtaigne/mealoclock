...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 29 Septembre 2015 à 19:07
...
INSERT INTO `communities` (`id`, `com_name`, `com_shortname`, `com_desc`) VALUES
(1, 'Végétariens', 'vege', 'Ami végétarien, par choix ou par obligation, tu rejettes la consommation de viande au profit des végétaux, légumineuses, graminées, racines, fruits et autres merveilles que la nature nous offre !\r\nTu n’es pourtant pas contre un petit oeuf à la coque ou une tartine de miel tant que les poules et les abeilles n’ont pas été maltraitées. Question de principe. Partage ou découvre ce mode alimentaire connu de tous mais pratiqué par peu.'),
(2, 'Vegans', 'vegan', 'Plus qu’un choix, c’est une cause : la défense des animaux. De ce fait, le régime vegan rejette tous produit d’origine animale ou provenant de l’exploitation d’animaux. Bien que restrictif au premier abord, ce régime alimentaire bénéfique pour l’homme et pour les animaux est très varié et il ne tient qu’à vous de faire découvrir ou de découvrir la richesse culinaire d’un monde sans produits animaliers.'),
(3, 'Sans Gluten', 'ssgluten', 'Petit, tu regardais tes camarades manger des tartines et des croissants. Tu en voulais, mais non. Ce n’était pas pour toi. Aujourd’hui, ta peur de la farine et de ses utilisations, ta peur du  gluten n’est plus un obstacle à une vie culinaire riche et variée et il ne tient qu’à toi de le faire découvrir.\r\nMangeur de croissant, rentre dans la vie de ton camarade et découvre une existence sans gluten le temps d’un repas, d’un petit-déjeuner ou d’un en-cas.'),
(4, 'Sans Lactose', 'sslactose', 'Les flatulences ne sont plus une fatalité depuis qu’on arrive à traire le soja. Lait végétal, faux-mage, crème sans lait, yaourts sans lactose... tout est possible ! Découvrez ou partagez cette cuisine alternative, pas si contraignante quand on a pris de bonnes habitudes. Vos intestins et vos voisins vous remercieront.');
...
INSERT INTO `users` (`id`, `user_name`, `user_email`, `password`, `role`, `user_photo`, `user_photo_thumb`, `user_desc`, `create_time`, `user_tel`) VALUES
...
(3, 'mWitting', 'Fletcher33@Jones.com', '$2y$10$9l1Mieg/Cx4DwtIPDB.WTuXoHJgMNkzxoddDQbRsxmrLUPCneZl0u', '', NULL, '', 'Salut à tous, je m''appelle mWitting et je suis avide de découverte!', '0000-00-00 00:00:00', NULL),
...
(5, 'Murphy.Alda', 'Nia.Daugherty@yahoo.com', '$2y$10$4BjICo93jngLRXVVzkdTne/vZjnYDE0ECD14yz1x5h0Ajf4ZbW/WG', '', NULL, '', 'Salut moi c''est Murphy! Je kiffe les radis!', '0000-00-00 00:00:00', NULL),
...
(45, 'gaston', 'gaston@mail.com', '$2y$10$ykVe8Ydj7eM6OdBQgWMQaO7UX4f.H/BkMw52KZzZ02qyJEEj7EaUS', 'user', '45_photo.jpg', '', 'Salut \r\nmoi\r\nc''est\r\nGaston!\r\n', '2015-09-23 09:45:26', NULL),
(46, 'julio', 'julio@mail.com', '$2y$10$m27E4VkD83T3TZ0ysqXW1e0gyp5VROhVvc4IN69nqWA2qNeRC.fCi', 'user', '46_photo.jpg', '46_photoThumb.jpg', NULL, '2015-09-26 15:18:45', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `users_events_participations`
--

CREATE TABLE IF NOT EXISTS `users_events_participations` (
...
--
-- Contenu de la table `users_events_participations`
--

INSERT INTO `users_events_participations` (`guest_id`, `event_id`, `status`, `message`) VALUES
(3, 10, 'confirmed', 'Youhou!'),
(3, 11, 'confirmed', 'Bonjour je souhaite participer à votre événement'),
(5, 7, 'confirmed', 'Yeah!!!!'),
(5, 11, 'confirmed', 'Moi vouloir participer'),
(8, 5, 'rejected', ''),
(10, 7, 'cancelled', ''),
(15, 8, 'tobeconfirmed', ''),
(16, 5, 'rejected', ''),
...
--
-- Index pour la table `users_events_participations`
--
ALTER TABLE `users_events_participations`
...
--
-- Contraintes pour la table `users_events_participations`
--
ALTER TABLE `users_events_participations`
